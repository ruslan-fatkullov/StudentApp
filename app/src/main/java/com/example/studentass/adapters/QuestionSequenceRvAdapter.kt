...
class QuestionSequenceRvAdapter(private val context: Context) : RecyclerView.Adapter<QuestionSequenceRvAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        val seq = view.sequence_item
        val up = view.itemUp
        val down = view.itemDown
        val ans = view.answer_text_seq
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): QuestionSequenceRvAdapter.ViewHolder {
        val inflater = LayoutInflater.from(context)
        return QuestionSequenceRvAdapter.ViewHolder(inflater.inflate(R.layout.sequence_question_item, parent, false))
    }

    override fun onBindViewHolder(holder: QuestionSequenceRvAdapter.ViewHolder, position: Int) {
